...
- Added `--chain` parameter to select blockchain network
- Support for multiple blockchain networks (Ethereum Mainnet, Rootstock)
- Proper configuration for each blockchain network in generated code
